...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-ecosa-mist text-zinc-900">
        <flux:sidebar sticky collapsible="mobile" class="border-e border-[#102b47] bg-[#173a60] text-white">
            <flux:sidebar.header>
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('ECOSA')" class="grid">
                    ...
                    <flux:sidebar.item icon="users" :href="route('site.membership')">
                        {{ __('Membership Hub') }}
                    </flux:sidebar.item>
        ...
        <!-- Mobile User Menu -->
        <flux:header class="border-b border-[#d7e4d5] bg-white lg:hidden">
