...
use App\Livewire\Site\CommunityBusinessNetwork;
...
use App\Livewire\Site\CommunityProfessionalNetwork;
use App\Livewire\Site\CommunitySaccos;
...
use App\Livewire\Site\MembershipWhoQualifies;
...
Route::livewire('membership/who-qualifies', MembershipWhoQualifies::class)->name('site.membership.qualifies');
...
Route::livewire('community/saccos-and-circles', CommunitySaccos::class)->name('site.community.saccos');
Route::livewire('community/business-network', CommunityBusinessNetwork::class)->name('site.community.business');
Route::livewire('community/professional-network', CommunityProfessionalNetwork::class)->name('site.community.professional');
